<?php
	...
	if($datos_venta->rowCount()==1){
        ...
        /*---------- Ajuste de formato según moneda de la venta ----------*/
        $__pdf_moneda_simbolo = MONEDA_SIMBOLO;
        $__pdf_moneda_decimales = MONEDA_DECIMALES;
        $__pdf_moneda_nombre = MONEDA_NOMBRE;
        if(isset($datos_venta['venta_moneda']) && strtolower($datos_venta['venta_moneda']) == 'usd'){
            $__pdf_moneda_simbolo = '$';
            $__pdf_moneda_decimales = 2;
            $__pdf_moneda_nombre = 'USD';
        }
        ...
        foreach($venta_detalle as $detalle){
            ...
            $pdf->Cell(22,4,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($detalle['venta_detalle_precio_venta'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)),0,0,'C');
            $pdf->Cell(32,4,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($detalle['venta_detalle_total'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR)),0,0,'C');
            $pdf->Ln(4);
            $pdf->Ln(3);
        }
        ...
        $pdf->Cell(32,5,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_total'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),0,0,'C');

        $pdf->Ln(5);
        
        $pdf->Cell(18,5,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
        $pdf->Cell(22,5,iconv("UTF-8", "ISO-8859-1","TOTAL PAGADO"),0,0,'C');
        $pdf->Cell(32,5,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_pagado'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),0,0,'C');

        $pdf->Ln(5);

        $pdf->Cell(18,5,iconv("UTF-8", "ISO-8859-1",""),0,0,'C');
        $pdf->Cell(22,5,iconv("UTF-8", "ISO-8859-1","CAMBIO"),0,0,'C');
        $pdf->Cell(32,5,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_cambio'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),0,0,'C');
