<?php
	...
	if($datos_venta->rowCount()==1){
		...
		foreach($venta_detalle as $detalle){
			...
			$pdf->Cell(32,7,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($detalle['venta_detalle_precio_venta'], $__pdf_moneda_decimales, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR)),'L',0,'C');
			$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($detalle['venta_detalle_total'], $__pdf_moneda_decimales, MONEDA_SEPARADOR_DECIMAL, MONEDA_SEPARADOR_MILLAR)),'LR',0,'C');
			$pdf->Ln(7);
		}
		...
		$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_total'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),'T',0,'C');
		...
		$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_pagado'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),'',0,'C');
		...
		$pdf->Cell(34,7,iconv("UTF-8", "ISO-8859-1", $__pdf_moneda_simbolo . number_format($datos_venta['venta_cambio'],$__pdf_moneda_decimales,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR) . ' ' . $__pdf_moneda_nombre),'',0,'C');
