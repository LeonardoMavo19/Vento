		  ...
		  <div class="column">
		    <div class="control">
				<label>Dólares (USD)</label>
			  		<input class="input" type="text" name="caja_dolares" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" >
				</div>
		  	</div>
		  <div class="column">
		    <div class="control">
				<label>POS (Bs)</label>
			  		<input class="input" type="text" name="caja_pos" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" >
				</div>
		  	</div>
		  <div class="column">
		    <div class="control">
				<label>Biopago (Bs)</label>
			  		<input class="input" type="text" name="caja_biopago" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" >
				</div>
		  	</div>
		</div>
		  ...
		  <div class="column">
		    <div class="control">
				<label>Pago móvil (Bs)</label>
			  		<input class="input" type="text" name="caja_pago_movil" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" >
				</div>
		  	</div>
		  <div class="column">
		    <div class="control">
				<label>Otros (Bs)</label>
			  		<input class="input" type="text" name="caja_otros" pattern="[0-9.]{1,25}" maxlength="25" value="0.00" >
				</div>
		  	</div>
		</div>
