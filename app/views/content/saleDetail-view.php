		...
		<div class="column">
			...
			<div class="full-width sale-details text-condensedLight">
				...
				<span class="has-text-link">
					<?php if($datos_venta['venta_moneda']=='usd'){ echo '$'.number_format($datos_venta['venta_total'],2,'.',','); }else{ echo MONEDA_SIMBOLO.number_format($datos_venta['venta_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE; } ?>
				</span>
			</div>
			...
			<div class="full-width sale-details text-condensedLight">
				...
				<span class="has-text-link">
					<?php if($datos_venta['venta_moneda']=='usd'){ echo '$'.number_format($datos_venta['venta_pagado'],2,'.',','); }else{ echo MONEDA_SIMBOLO.number_format($datos_venta['venta_pagado'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE; } ?>
				</span>
			</div>
			...
			<div class="full-width sale-details text-condensedLight">
				...
				<span class="has-text-link">
					<?php if($datos_venta['venta_moneda']=='usd'){ echo '$'.number_format($datos_venta['venta_cambio'],2,'.',','); }else{ echo MONEDA_SIMBOLO.number_format($datos_venta['venta_cambio'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE; } ?>
				</span>
			</div>
                ...
                <table class="table is-bordered is-striped is-narrow is-hoverable is-fullwidth">
                    ...
                    <tbody>
                        ...
                        <tr class="has-text-centered" >
							...
							<td>
								<span>
									<?php if($datos_venta['venta_moneda']=='usd'){ echo '$'.number_format($detalle['venta_detalle_precio_venta'],2,'.',','); }else{ echo MONEDA_SIMBOLO.number_format($detalle['venta_detalle_precio_venta'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE; } ?>
								</span>
							</td>
							<td>
								<span>
									<?php if($datos_venta['venta_moneda']=='usd'){ echo '$'.number_format($detalle['venta_detalle_total'],2,'.',','); }else{ echo MONEDA_SIMBOLO.number_format($detalle['venta_detalle_total'],MONEDA_DECIMALES,MONEDA_SEPARADOR_DECIMAL,MONEDA_SEPARADOR_MILLAR).' '.MONEDA_NOMBRE; } ?>
								</span>
							</td>
                        </tr>
                        <?php
...
<!-- Valores mostrados en la moneda de la venta (renderizados en servidor) -->
	<?php
