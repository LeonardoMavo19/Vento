...
<div class="container pb-6 pt-6">
	...
	<form class="FormularioAjax" action="<?php echo APP_URL; ?>app/ajax/productoAjax.php" method="POST" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
			<label>Precio de compra (USD) <?php echo CAMPO_OBLIGATORIO; ?></label>
			<input class="input" type="text" name="producto_precio_compra" value="<?php echo number_format($datos['producto_precio_compra'],2,'.',''); ?>" pattern="[0-9.,]{1,25}" maxlength="25" value="0.00" required >
			</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
				<label>Precio de venta (USD) <?php echo CAMPO_OBLIGATORIO; ?></label>
				<input class="input" type="text" name="producto_precio_venta" value="<?php echo number_format($datos['producto_precio_venta'],2,'.',''); ?>" pattern="[0-9.,]{1,25}" maxlength="25" value="0.00" required >
				</div>
		  	</div>
		  	<div class="column">
		    	<div class="control">
